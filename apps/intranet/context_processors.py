...
GERENCIAL_LINKS = [
    ...
    {"name": "Cota365 - Resumo (Link Público)", "url": reverse('cota365:gerar_link_publico_resumo'), "copy_text": True},
...
def navbar_links(request):
    ...
    show_pessoas_menu = False
    show_propostas_menu = False
    show_contratos_menu = False
    ...
    return {
        ...
        "show_pessoas_menu": show_pessoas_menu,
        "show_propostas_menu": show_propostas_menu,
        "show_contratos_menu": show_contratos_menu,
    }
